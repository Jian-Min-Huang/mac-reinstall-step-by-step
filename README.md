...
```bash
brew install --cask obs slack dropbox sourcetree postman alfred orbstack setapp jetbrains-toolbox tunnelblick discord figma mongodb-compass redisinsight visual-studio-code@insiders dbeaver-community claude codex raycast claude-code vlc
```
...
```bash
brew install cmake awscli jq wrk gh opencc copilot-cli agent-browser
```
